      ...
      "Rota = Köln" yazdırın.
       ...
       case:1  ise
        ...
        switch (hedef) {
            ...
            case "FRANKFURT":
                System.out.println("hedef FRANKFURT, kaç kişilik bilet alacaksınız?(1/2)");
                int kisiSay = scan.nextInt();
                int ücret;
                switch (kisiSay) {
                    case 1:
                        toplamfyt = frnkKm / 20 * 5;
                        System.out.println("bilet ücretiniz: " + toplamfyt+"devam etmek için 1/ çıkmak için 2 giriniz.");
                        int devam = scan.nextInt();
                        if (devam ==1){}
                        break;
                    case 2:
                        toplamfyt = frnkKm / 20 * 5 * kisiSay;
                        System.out.println("bilet ücretiniz: " + toplamfyt);
                        break;
                    default:
                        System.out.println("yanlış ve hatalı giriş yaptınız.");
                }
                break;
            ...
            case "KOLN":
                System.out.println("hedef KOLN, kaç kişilik bilet alacaksınız?(1/2)");
            ...
            double paraustu = bakiye- toplamfyt;
            if (bakiye>toplamfyt){
